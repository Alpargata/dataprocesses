...
```
So as we can see, the loops will still ocurr, but a general decay trend is still hapening, so the ice will still melting in the northern part of the earth. Not a very promising future either!
## Results

## Discussion and future work  
There are interesting aspects in the data that could be understan from the perspective of the time: seasonality, trend, etc. 
